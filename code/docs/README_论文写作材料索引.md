...
| RuralVoltage | 2 | 0.6191 | TPATimesNet | 🔄 进行中 |

### 进行中实验

| 数据集 | 模型 | 状态 | 备注 |
|:------:|:----:|:----:|------|
| RuralVoltage | VoltageTimesNet | 🔄 训练中 | 运行 4h+ |
| SMAP | TimesNet | 🔄 训练中 | 检查点已生成 |

### 待运行实验

- [ ] RuralVoltage - TimesNet
- [ ] RuralVoltage - DLinear
- [ ] RuralVoltage - Transformer
- [ ] 消融实验 - 混合周期比例
- [ ] 消融实验 - 序列长度
- [ ] 消融实验 - 模型深度
