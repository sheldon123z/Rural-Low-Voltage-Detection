...
def main():
    ...
    parser.add_argument("--model_id", type=str, default="test", help="model identifier")
    parser.add_argument(
        "--model",
        type=str,
        default="TimesNet",
    ...
    parser.add_argument(
        "--target", type=str, default="OT", help="target feature (S or MS tasks)"
    )
    parser.add_argument(
        "--freq", type=str, default="h", help="time features encoding: s/t/h/d/b/w/m"
    )
    parser.add_argument(
        "--checkpoints",
        type=str,
    ...
    parser.add_argument(
        "--seq_len", type=int, default=100, help="input sequence length (window size)"
    )
    parser.add_argument(
        "--label_len",
        type=int,
    ...
    parser.add_argument(
        "--top_k", type=int, default=5, help="TimesNet: number of top-k frequencies"
    )
    parser.add_argument(
        "--num_kernels",
        type=int,
    ...
    parser.add_argument(
        "--dec_in", type=int, default=25, help="decoder input dimension"
    )
    parser.add_argument("--c_out", type=int, default=25, help="output dimension")
    ...
    parser.add_argument(
        "--d_ff", type=int, default=64, help="dimension of feed-forward network"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--des", type=str, default="test", help="experiment description"
    )
    parser.add_argument("--loss", type=str, default="MSE", help="loss function")
    parser.add_argument(
        "--lradj", type=str, default="type1", help="learning rate adjustment type"
    )
    parser.add_argument(
        "--use_amp",
        action="store_true",
    ...
    parser.add_argument(
        "--devices", type=str, default="0,1,2,3", help="GPU device ids for multi-GPU"
    )
