...
from .VoltageTimesNet_v2 import Model as VoltageTimesNet_v2  # Recall-optimized VoltageTimesNet
...
model_dict = {
    ...
    "VoltageTimesNet_v2": VoltageTimesNet_v2,  # Recall-optimized version
}
