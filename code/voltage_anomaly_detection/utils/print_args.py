"""
Print arguments for Voltage Anomaly Detection
"""
...
def print_args(args):
    ...
    print(
        f'  {"Features:":<20}{args.features:<20}{"Checkpoints:":<20}{args.checkpoints:<20}'
    )
    print()

    print("\033[1m" + "Anomaly Detection Task" + "\033[0m")
    print(
        f'  {"Seq Len:":<20}{args.seq_len:<20}{"Anomaly Ratio:":<20}{args.anomaly_ratio:<20}'
    )
    print()
