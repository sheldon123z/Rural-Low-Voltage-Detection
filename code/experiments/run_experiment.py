...
# Note: The following are used in the deprecated code below but never executed
# from exp.exp_anomaly_detection import Exp_Anomaly_Detection  # noqa: F401
# from utils.print_args import print_args  # noqa: F401
# Placeholder definitions to satisfy flake8 for unreachable code
Exp_Anomaly_Detection = None  # noqa: F811
EXPERIMENT_MODELS = []  # noqa: F811
get_experiment_model = None  # noqa: F811
print_args = None  # noqa: F811
...
def main():
    parser = argparse.ArgumentParser(
        description="Rural Voltage Anomaly Detection Experiments"
    )

    # Basic Config
    parser.add_argument(
        "--is_training", type=int, default=1, help="status: 1=train, 0=test only"
    )
    parser.add_argument(
        "--model_id", type=str, default="experiment", help="model identifier"
    )
    parser.add_argument(
        "--model",
        type=str,
    ...
    # Data Config
    parser.add_argument("--data", type=str, default="RuralVoltage", help="dataset name")
    parser.add_argument(
        "--root_path",
        type=str,
    ...
    parser.add_argument(
        "--data_path", type=str, default="data.csv", help="data file name"
    )
    parser.add_argument(
        "--features", type=str, default="M", help="M: multivariate, S: univariate"
    )
    ...
    parser.add_argument(
        "--top_k", type=int, default=5, help="number of top-k frequencies"
    )
    parser.add_argument(
        "--num_kernels",
        type=int,
    ...
    parser.add_argument(
        "--enc_in", type=int, default=17, help="encoder input dimension"
    )
    parser.add_argument(
        "--dec_in", type=int, default=17, help="decoder input dimension"
    )
    parser.add_argument("--c_out", type=int, default=17, help="output dimension")
    parser.add_argument("--d_model", type=int, default=64, help="model dimension")
    parser.add_argument(
        "--n_heads", type=int, default=4, help="number of attention heads"
    )
    parser.add_argument(
        "--e_layers", type=int, default=2, help="number of encoder layers"
    )
    parser.add_argument(
        "--d_layers", type=int, default=1, help="number of decoder layers"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--distil", action="store_false", default=True, help="whether to use distilling"
    )
    ...
    parser.add_argument(
        "--output_attention", action="store_true", help="whether to output attention"
    )
    ...
    # Training Config
    parser.add_argument(
        "--num_workers", type=int, default=10, help="data loader workers"
    )
    ...
    parser.add_argument(
        "--des", type=str, default="experiment", help="experiment description"
    )
    parser.add_argument("--loss", type=str, default="MSE", help="loss function")
    parser.add_argument(
        "--lradj", type=str, default="type1", help="learning rate adjustment"
    )
    parser.add_argument(
        "--use_amp",
        action="store_true",
